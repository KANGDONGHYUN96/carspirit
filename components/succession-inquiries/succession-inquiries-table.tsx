...
import { SuccessionInquiry } from '@/types/database.types'
import { createClient } from '@/lib/supabase/client'
import SuccessionInquiryDetailModal from './succession-inquiry-detail-modal'

interface SuccessionInquiriesTableProps {
  inquiries: SuccessionInquiry[]
  userId: string
  userName: string
}
...
export default function SuccessionInquiriesTable({ inquiries, userId, userName }: SuccessionInquiriesTableProps) {
  const [selectedInquiry, setSelectedInquiry] = useState<SuccessionInquiry | null>(null)
      ...
      <div className="bg-white rounded-2xl border border-gray-200 shadow-sm">
        ...
        {filteredInquiries.length === 0 ? (
          <div className="p-12 text-center">
            ...
            <p className="text-gray-500 text-lg font-medium">승계문의가 없습니다</p>
            <p className="text-gray-500 text-sm mt-1">새로운 승계문의가 들어오면 여기에 표시됩니다</p>
          </div>
        ) : (
